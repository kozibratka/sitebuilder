...
import {AbstractMenuPluginResolverMessenger} from '../../../../admin/entry-route/administration/admin/page-builder-module/page-builder/tools/messengers/abstract-classes/abstract-menu-plugin-resolver-messenger';
